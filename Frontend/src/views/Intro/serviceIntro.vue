      ...
      <div class="carousel-inner" style="width:75%;margin: auto;">
        <div class="carousel-item active" style="display:block;">
          ...
          <div class="carousel-caption d-none d-md-block">
            ...
            <p> 환경 경영 <br> 에너지 사용량, 온실가스 배출량으로 기준으로 평가합니다. </p>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            ...
            <p>사회 책임 경영 <br> 평등한 고용 사회를 만들기 위해 임원 내 여성비율, 기간제 근로자 비율 등을 기준으로 평가합니다. </p>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h5>Governance</h5>
            <p>기업 지배 구조 <br> 투명한 지배구조를 갖춘 기업으로, 이사회 독립성, 배당 성향 등으로 평가합니다.  </p>
          </div>
        </div>
      </div>
    ...
    <div style="width:75%;margin:auto;" class="mt-5">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
          저금리, 저성장 기조가 장기화되며 투자자들은 은행 예금 상품에 한계를 느끼고 있습니다. <br>
          동학 개미운동이라는 단어가 등장할 정도로 투자에 대한 관심도가 높아진 지금, 기업을 평가하는 새로운 기준인 ESG가 등장하게 되었습니다. <hr>
          BEE는 기업이 사회, 환경, 지배구조 부분에서 가치를 실현하는지 다각도에서 평가한 후, 비재무적 정보를 활용하여 지속 가능 경영에 대한 정보를 제공하고자 합니다. 
           </div>
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
          ESG 경영이란 무엇일까요 <br>
          2004년 UN에서 처음 사용되어, 투자자가 <b>환경, 사회, 거버넌스</b>와 같은 ESG 요소를 통합적으로 고려하여 투자하는 것이
          건강한 투자라는 인식을 심어준 용어입니다. <hr>
          ESG 경영이란 'Environment' 환경, 'Social' 사회, 'Governance' 지배구조의 앞 글자를 따서 만들어진 단어로 
          기업이 친환경, 사회적 책임, 지배구조 개선 등을 고려해야 지속 가능한 경영을 할 수 있다는 의미를 가지고 있습니다.<br> 환경, 사회, 지배구조 관련 이슈뿐만 아니라 기업의 재무성과 지속 가능성에 영향을 미칠 수 있는 
          모든 비재무적 요인들을 포함하기도 합니다. 
        </div>
      </div>
    </div>
